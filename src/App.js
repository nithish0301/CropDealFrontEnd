    ...
    <div className="picture">
      <nav className="navbar navbar-expand navbar-dark bg-dark">
        ...
        <div className="navbar-nav mr-auto">
          ...
          {showDealerBoard && (
              <div className="navbar-nav ml-auto" style={{width:"10px"}}>
        ...
        {currentUser ? (
          <div className="navbar-nav ml-auto" style= {{marginLeft:"170px"}}>
            ...
            <li style={{marginLeft:"0px",paddingTop:"10px",width:"150px"}}className="nav-item" >
          ...
          <div className="navbar-nav ml-auto">
            <li style={{paddingTop:"9px",paddingRight:"0px"}} className="nav-item">
